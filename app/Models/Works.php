...
class Works extends Base
{
    ...
    protected $fillable = [
        'column_id', 'title', 'subtitle', 'type', 'cover_img', 'detail_img', 'user_id', 'original_price', 'price', 'is_end', 'status', 'timing_online', 'content', 'is_pay', 'is_free', 'chapter_num', 'comment_num', 'collection_num', 'duration','is_audio_book'
    ];
