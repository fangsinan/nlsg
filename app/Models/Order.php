...
class Order extends Base
{
    ...
    protected $fillable = [
        ...
        'pay_price', 'city', 'vip_order_type', 'send_type', 'send_user_id', 'remark', 'sales_id', 'sales_bind_id','protect_user_id',
    ...
    static function getInfo($type, $relation_id, $send_type, $user_id = 0)
    {
        ...
        switch ($type) {
            ...
            case 10:
                ...
                'is_forb','is_join','relation_live','status','is_test','flag','cover_vertical_img as cover_images'
