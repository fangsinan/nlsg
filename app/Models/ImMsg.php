...
class ImMsg extends Base
{
    ...
    public static function getMsgList($ids=[],$msg_keys=[]){
        ...
        $query = ImMsg::with([
            'content:id,msg_id,msg_type as MsgType,text as Text,url as Url,video_url as VideoUrl,thumb_url as ThumbUrl,data as Data,file_name as FileName,file_size as FileSize,uuid,image_format as ImageFormat,file_name as FileName,size as VideoSize,video_format as VideoFormat,thumb_url as ThumbUrl,thumb_size as ThumbSize,thumb_width as ThumbWidth,thumb_height as ThumbHeight,thumb_format as ThumbFormat,second as VideoSecond,video_uuid,uuid as UUID',
        ...
        foreach ($msg_content as $key=>$val) {
            ...
            switch ($msg_type){
                ...
                case 'TIMVideoFileElem' : //视频类型元素
                    ...
                    $msg_content_add['VideoSecond']         = intval(round($val['VideoSecond']))??0;
