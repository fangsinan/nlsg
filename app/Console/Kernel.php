...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
		...
		})->everyTenMinutes()->runInBackground();//每十分钟
		...
		})->everyMinute()->between('10:00', '10:50')->runInBackground();//每分钟执行一次
	   ...
	   $schedule->command('command:XeUserJob 30')->everyMinute()->withoutOverlapping(3)->runInBackground()->onOneServer();
        ...
        })->everyTenMinutes()->between('22:02', '23:52')->runInBackground();//10分钟执行一次
