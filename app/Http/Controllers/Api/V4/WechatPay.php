        ...
        if ($type == 16) {
            ...
            switch ($relation_id) {
                ...
                case 9: //经营幸福人生
                    ...
                    break;
                case 10: //哈佛凌晨四点半--抖音陪读教材
                    $res = $nickname . ':您已支付' . $live_num . '哈佛凌晨四点半--抖音陪读教材';
                    break;
                case 12: //30天演讲口才(亲子)训练营
                    $res = $nickname . ':您已支付' . $live_num . '单30天演讲口才(亲子)训练营';
                    break;
                case 13: //吴岩老师直播福利
                    $res = $nickname . ':您已支付' . $live_num . '单 吴岩老师直播福利';
                    break;
				case 14: //5天学习力诊断课
