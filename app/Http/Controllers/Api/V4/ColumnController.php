...
class ColumnController extends Controller
{
    ...
    public function getColumnWorks(Request $request){
        ...
        $field = ['id', 'name', 'column_type', 'subtitle', 'type', 'user_id', 'message', 'original_price', 'price', 'online_time', 'works_update_time', 'cover_pic', 'details_pic', 'is_end', 'subscribe_num','collection_num','comment_num','info_num','is_free','category_id','info_num'];
