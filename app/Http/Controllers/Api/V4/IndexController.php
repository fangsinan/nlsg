...
class IndexController extends Controller
{
    ...
    public function indexPosition()
    {
        ...
        $head   = RecommendConfig::select("id","title","icon_pic","jump_type","modular_type","sort","jump_url")->where(['show_position'=>1, 'is_show'=>1,])->OrderBy("sort",'asc')->get()->toArray();
        $bottom = RecommendConfig::select("id","title","icon_pic","jump_type","modular_type","sort","jump_url")->where(['show_position'=>3, 'is_show'=>1,])->OrderBy("sort",'asc')->get()->toArray();
        $icon   = RecommendConfig::select("id","title","icon_pic","jump_type","modular_type","sort","jump_url")->where(['show_position'=>2, 'is_show'=>1,])->OrderBy("sort",'asc')->get()->toArray();
