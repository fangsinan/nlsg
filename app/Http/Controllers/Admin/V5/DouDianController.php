            ...
            if ($temp_data->isEmpty()) {
                ...
                foreach ($temp_data as $v) {
                    foreach ($v['order_list'] as $vv) {
                        ...
                        $temp_put_data['post_addr']         = $v['post_addr_province_name'] .
                            $v['post_addr_city_name'] . $v['post_addr_town_name'];
                        $temp_put_data['post_addr_detail']  = $v['post_addr_detail'];
                        $temp_put_data['post_addr_full']    = $temp_put_data['post_addr'] .
                            $temp_put_data['post_addr_detail'];
                        ...
                        $temp_put_data['product_type']    = $vv['product_info']['product_type'] == 3 ? '虚拟商品' : '普通商品';
