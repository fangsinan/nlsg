...
Route::group(['namespace' => 'Api\V4', 'prefix' => 'v4'], function () {
    ...
    Route::post('auth/check_wechat_phone', 'AuthController@changePhone');
    ...
    Route::get('auth/refresh_wechat_token', 'AuthController@refresh_wechat_token');
...
Route::group(['namespace' => 'Api\V5', 'prefix' => 'v5'], function () {
    ...
    Route::any('live/get_works_live', 'LiveController@getWorksInfoLive');
